...
public class Exercise1 {
    ...
    public static void main(String[] args) {
        ...
        // TODO: Write code here
        Integer integer = StreamSources.intNumbersStream().filter(a -> a > 5).findFirst().orElse(-1);
        System.out.println(integer);
        ;
        // Print first names of all users in userStream
        // TODO: Write code here
        StreamSources.userStream().map(s -> s.getFirstName()).forEach(System.out::println);
